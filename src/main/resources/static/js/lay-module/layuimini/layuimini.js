...
layui.define(["element", "jquery"], function (exports) {
    ...
    layuimini = new function () {
        ...
        this.init = function () {
            ...
            $.ajax({
          	  type: "POST",
          	  url: "/privilege/menu/queryMenuList",
          	  cache: false,
          	  async:false,
        ...
        this.initMenu = function (data) {
            ...
            $.each(data, function (key, val) {
                headerMenuHtml += '<li class="DDD layui-nav-item ' + headerMenuCheckDefault + '" id="' + key + 'HeaderId" data-menu="' + key + '"> <a href="javascript:;"><i class="' + val.icon + '"></i> ' + val.title + '</a> </li>\n';
                ...
                $.each(menuList, function (index, menu) {
                    ...
                    if (menu.child != undefined && menu.child != []) {
                        ...
                        leftMenuHtml += '<a href="javascript:;" class="layui-menu-tips"  data-type="tabAdd" data-tab-mpi="m-p-i-' + menuParameId + '" data-tab="' + menu.href + '" target="' + menu.target + '">' +
                            '<i class="' + menu.icon + '"></i>' +
                            '<span class="layui-left-nav"> ' + menu.title + '</span>';
                        if(menu.rightIcon){//仅限于首页的收缩按钮
                            leftMenuHtml += '<span data-side-fold="1" class="right-icon fold-out">' +
                                '<i class="' + menu.rightIcon + '"></i>'+
                                '</span>';
                        }else{
                        ...
                        //     '<i class="' + menu.icon + '"></i>' +
                        //     '<span class="layui-left-nav"> ' + menu.title + '</span>' +
                        //     '<i class="right-icon ' + menu.rightIcon + '"></i>' +
                        //     '</a>\n';
